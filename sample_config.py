...
class Config(object):
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "SDBOTs_inifinity")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "SDBOTs_inifinity")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/SDBOTs_inifinity")
    ...
    APP_DESCRIPTION = os.environ.get("APP_DESCRIPTION", "created using Python")
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Please Subscribe ❤️ @SDBOTs_inifinity")
